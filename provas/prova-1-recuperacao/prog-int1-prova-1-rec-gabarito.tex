...
\vspace{0.2cm}
\textbf{3.} No JavaScript, como capturamos o valor digitado pelo usuário em um campo \texttt{<input id="nome">}?
\begin{enumerate}[label=(\alph*)]
    \item \texttt{document.getElementById("nome").textContent}
    \item \texttt{document.getElementById("nome").innerHTML}
    \item \correto{\texttt{document.getElementById("nome").value}}
    \item \texttt{document.getElementById("nome").type}
\end{enumerate}
