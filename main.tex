...
\fancyhead[R]{
\textbf{UC – Programação para Internet I}\\
...
Esta unidade curricular tem como objetivo desenvolver competências para a construção de sistemas para internet, integrando tecnologias frontend e server side, com utilização de banco de dados e aplicação prática em contexto real.

Ao longo do semestre, os estudantes irão projetar e implementar um sistema web funcional, aplicando conhecimentos de HTML, CSS, JavaScript, programação server side e integração com banco de dados.

A disciplina será orientada por uma perspectiva prática, incremental e profissional, incentivando organização, autonomia, raciocínio lógico e responsabilidade no desenvolvimento de soluções tecnológicas.

\subsection*{Estrutura do Semestre}

O semestre está organizado em 6 etapas estruturantes, distribuídas ao longo dos encontros:

\begin{enumerate}
    \item \textbf{Fundamentos da Web e Estrutura HTML} \\
    Compreensão da arquitetura cliente-servidor e construção de páginas estruturadas com HTML5.

    \item \textbf{Estilização e Construção de Layouts} \\
    Aplicação de CSS, técnicas de layout moderno, responsividade e uso de framework CSS.

    \item \textbf{Interatividade com JavaScript} \\
    Manipulação de DOM, eventos e validação de formulários.

    \item \textbf{Programação Server Side} \\
    Desenvolvimento de aplicação web estruturada utilizando linguagem server side.

    \item \textbf{Integração com Banco de Dados} \\
    Implementação de operações CRUD e persistência de dados em base relacional.

    \item \textbf{Projeto Integrador com Extensão} \\
    Desenvolvimento e aplicação de sistema web para atender demanda real da comunidade.
\end{enumerate}
...
\begin{itemize}
    \item Compreender o funcionamento da arquitetura web;
    \item Desenvolver interfaces estruturadas com HTML e CSS;
    \item Construir layouts responsivos utilizando framework CSS;
    \item Implementar interações básicas com JavaScript;
    \item Desenvolver aplicações web com programação server side;
    \item Integrar banco de dados em sistemas para internet;
    \item Projetar e implementar um sistema web funcional;
    \item Aplicar soluções tecnológicas em contexto comunitário.
\end{itemize}

\subsection*{Metodologia}

A disciplina será conduzida por meio de aprendizagem baseada em projetos (Project-Based Learning), com desenvolvimento incremental de um sistema web ao longo do semestre.

Cada etapa envolverá momentos de fundamentação teórica, atividades práticas em laboratório e evolução progressiva do projeto.

A atividade de extensão será integrada ao projeto final, conduzindo os estudantes à aplicação da solução desenvolvida em contexto real.

\subsection*{Avaliação da Aprendizagem}

A avaliação será processual, contínua e cumulativa, considerando a evolução técnica do projeto e o desempenho individual do estudante.

A nota final será composta por quatro componentes:

\begin{itemize}
    \item \textbf{Etapa 1 – Frontend Estrutural (20\%)} \\
    Implementação correta de HTML, organização semântica e estrutura adequada de navegação.

    \item \textbf{Etapa 2 – Layout e Interatividade (20\%)} \\
    Aplicação de CSS, responsividade, uso de framework e implementação de interações com JavaScript.

    \item \textbf{Etapa 3 – Backend e Banco de Dados (30\%)} \\
    Implementação funcional de rotas, formulários, persistência de dados e operações CRUD.

    \item \textbf{Etapa 4 – Projeto Integrador com Extensão (20\%)} \\
    Aplicação do sistema desenvolvido para atender demanda real, incluindo documentação técnica e apresentação final.

    \item \textbf{Participação e Desempenho Individual (10\%)} \\
    Considerando assiduidade, pontualidade, participação ativa nas aulas, organização, postura profissional e cumprimento de prazos.
\end{itemize}

A avaliação prioriza a coerência técnica do sistema desenvolvido, a integração adequada das tecnologias estudadas e a capacidade de aplicação prática dos conhecimentos adquiridos.
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figures/roteiro-04-layout-final.jpeg}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figures/roteiro-5-checkpoint-1.jpg}}
...
\section{Roteiro Prático 07 — Introdução ao JavaScript e Consumo de API}
...
\begin{itemize}
\item Entender o funcionamento básico do JavaScript;
\item Manipular elementos da página;
\item Trabalhar com eventos;
\item Capturar dados de inputs;
\item Consumir uma API utilizando fetch.
\end{itemize}
\end{boxObjetivos}
...
Nesta aula, teremos o primeiro contato com JavaScript.

Antes de trabalhar com APIs, vamos explorar como o JavaScript pode modificar a página em tempo real.

% =====================================================
% PARTE 1 — PRIMEIRO CONTATO
% =====================================================

\subsection{Parte 1 — Criando uma Página de Teste}
...
\subsection{Parte 2 — Exibindo Alertas}
...
% =====================================================
% PARTE 3 — ALTERANDO A PÁGINA
% =====================================================

\subsection{Parte 3 — Alterando Estilos}
...
\begin{itemize}
\item Alterar a cor para outra cor;
\item Testar diferentes valores;
\item Modificar também a cor do texto.
\end{itemize}

\end{boxAtividade}

% =====================================================
% PARTE 4 — ALTERANDO TEXTO
% =====================================================

\subsection{Parte 4 — Modificando Conteúdo}
...
% =====================================================
% TABELA — EXPLORAÇÃO DE PROPRIEDADES E EVENTOS
% =====================================================

\subsection{Exploração — Propriedades e Eventos JavaScript}

A tabela abaixo apresenta algumas propriedades e eventos que podem ser utilizados para modificar elementos da página.
...
\color{white}\textbf{Exemplo} &
\color{white}\textbf{Descrição / Possibilidades} \\
\hline

innerText &
element.innerText = "Novo texto" &
Altera o texto do elemento. Pode ser usado para mensagens dinâmicas. \\
\hline

style.color &
element.style.color = "red" &
Altera a cor do texto. Testar: red, blue, green, black \\
\hline

style.backgroundColor &
document.body.style.backgroundColor = "lightblue" &
Altera a cor de fundo. Testar: yellow, pink, gray \\
\hline

style.fontSize &
element.style.fontSize = "20px" &
Altera o tamanho da fonte. Testar: 12px, 18px, 30px \\
\hline

style.border &
element.style.border = "2px solid black" &
Adiciona borda ao elemento. Testar diferentes cores e espessuras \\
\hline
...
Executa ação ao clicar em um elemento \\
\hline

mouseover &
addEventListener("mouseover", ...) &
Executa ação ao passar o mouse sobre o elemento \\
\hline

mouseout &
addEventListener("mouseout", ...) &
Executa ação ao retirar o mouse do elemento \\
\hline

input &
addEventListener("input", ...) &
Executa ação enquanto o usuário digita \\
\hline

change &
addEventListener("change", ...) &
Executa ação ao alterar um campo (ex: select) \\
\hline
...
\begin{boxAtividade}[Explorando JavaScript]

\begin{itemize}
\item Alterar a cor de fundo da página;
\item Modificar o texto do título;
\item Criar um efeito ao passar o mouse;
\item Capturar o valor digitado em um campo;
\item Exibir mensagens personalizadas.
\end{itemize}
...
% =====================================================
% PARTE 5 — VOLTANDO AO FORMULÁRIO
% =====================================================

\subsection{Parte 5 — Aplicando no Projeto}

Agora vamos utilizar JavaScript no formulário criado anteriormente.
...
\subsection{Parte 6 — Buscando Dados}

Substitua o código anterior:
...
\begin{itemize}
\item JavaScript alterando a página;
\item Eventos funcionando;
\item Dados sendo buscados da internet;
\item Integração com formulário.
\end{itemize}
...
\begin{boxDica}
\textbf{Como funciona o código com fetch?}

Vamos entender passo a passo o que está acontecendo:

\begin{itemize}

\item \textbf{fetch(url)}  
Realiza uma requisição para um servidor na internet.  
No nosso caso, estamos consultando a API do ViaCEP.

\item \textbf{response}  
É a resposta do servidor.  
Ainda não é o dado final, apenas a resposta da requisição.

\item \textbf{response.json()}  
Converte a resposta para o formato JSON (JavaScript Object).  
Agora podemos acessar os dados como \texttt{dados.logradouro}, \texttt{dados.localidade}, etc.

\item \textbf{.then(...)}  
Define o que deve acontecer após a resposta chegar.  
Como a requisição leva um tempo, usamos \texttt{then} para continuar o código depois.

\item \textbf{=> (arrow function)}  
É uma forma simplificada de escrever funções em JavaScript.  
...
\item \textbf{Fluxo geral do código}

\begin{enumerate}
\item O usuário clica no botão;
\item O JavaScript captura o valor do CEP;
\item O \texttt{fetch} envia a requisição;
\item O servidor responde com os dados;
\item O \texttt{.then()} recebe esses dados;
\item O JavaScript atualiza a página com o resultado.
\end{enumerate}

\end{itemize}

\textbf{Resumo:}  
O JavaScript pede dados → o servidor responde → o código trata a resposta → a página é atualizada.
...
% ==========================================
% TABELA DIDÁTICA FINAL
% =====================================================

\subsection{Tabela de Referência — JavaScript Utilizado}
...
\color{white}\textbf{Comando} &
\color{white}\textbf{Exemplo} &
\color{white}\textbf{O que faz} \\
\hline

getElementById & document.getElementById("cep") & Seleciona um elemento pelo ID \\
\hline

addEventListener & botao.addEventListener("click", fn) & Executa função ao clicar \\
\hline

function & function() \{...\} & Define uma função \\
\hline

fetch & fetch(url) & Faz requisição para internet \\
\hline

then & .then(...) & Executa após resposta \\
\hline

response.json & response.json() & Converte resposta para JSON \\
\hline

template string & `\${cep}` & Insere variável dentro da URL \\
\hline

innerText & elemento.innerText & Altera texto na tela \\
\hline

if & if(condição) \{...\} & Estrutura de decisão \\
\hline

return & return & Interrompe execução \\
\hline

console.log & console.log(dados) & Mostra dados no console \\
\hline
